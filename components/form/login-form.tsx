...
const SuccessPage: React.FC = () => (
  <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md text-center animate-fade-in">
    ...
    <h2 className="text-2xl font-bold text-gray-800">Welcome back, Hunter!</h2>
...
const LoginForm: React.FC = () => {
  ...
  const fullTitle = 'Welcome to Standard Homes Gambia!';
  ...
  const renderContent = () => {
    ...
    return (
      <div className={`w-full max-w-md p-8 space-y-6 bg-white rounded-2xl shadow-xl ${isShaking ? 'animate-shake' : ''}`}>
        <div className="text-center">
          <h1 className="text-3xl font-bold text-indigo-950 h-10">
            {displayedTitle}
            {displayedTitle.length < fullTitle.length && <span className="animate-ping">|</span>}
          </h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className={`mt-1 block w-full px-3 py-2 bg-white border ${errors.email ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all`}
            />
          ...
          <div>
            ...
            <input
              ...
              className={`mt-1 block w-full px-3 py-2 bg-white border ${errors.password ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all`}
            />
        ...
        <p className="text-xs text-center text-gray-500">
          By tapping Continue, you agree to Standard homes properties <a href="#" className="font-medium text-indigo-600 hover:underline">Terms of Service</a> and acknowledge that your personal data will be processed as described in our <a href="#" className="font-medium text-indigo-600 hover:underline">Privacy Policy</a>.
        </p>
